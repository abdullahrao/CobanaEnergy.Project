$(document).ready(function () {
    ...
    var table = $('#resolveContractsTable').DataTable({
        responsive: true,
        paging: true,
        ordering: true,
        searching: true,
        ...
        columnDefs: [
            {
                targets: [4, 5, 6, 7], // InputDate (4), StartDate (5), CED (6), CEDCOT (7) columns
                type: 'date-dd-mm-yy'
            }
        ]
    });
    ...
    enableColumnResizing('#resolveContractsTable');
    ...
    function loadContracts() {
        ...
        $.ajax({
            url: '/ResolveContractsDashboard/GetResolveContracts',
            type: 'POST',
            data: {
            ...
            error: function () {
                table.clear().draw();
                showToastError("Error loading resolve contracts.");
            }
        });
    }
