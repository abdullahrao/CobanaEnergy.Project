            ...
            success: function (res) {
                ...
                if (res.success) {
                    ...
                    res.Data.Contracts.forEach(contract => {
                        ...
                        table.row.add([
                            `<a href="javascript:void(0)" id="openEditPaymentPopup" data-eid="${contract.EId}" data-paymentstatus="${contract.PaymentStatus}" data-contracttype="${contract.ContractType}" class="${buttonClass}" title="Edit"><i class="${iconClass}"></i></a>`,
