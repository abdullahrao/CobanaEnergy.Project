...
namespace CobanaEnergy.Project.Models.Electric
{
    public class ElectricContractCreateViewModel
    {
        ...
        public string EMProcessor { get; set; } // Usually set in controller from User.Identity.Name
